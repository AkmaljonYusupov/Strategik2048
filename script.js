 // 4x4 o'yin taxtasi massivi
        ...
        // Ovoz effektlari
        const smallMergeSound = new Audio('https://www.soundjay.com/buttons/sounds/button-09.mp3');
        const mediumMergeSound = new Audio('https://www.soundjay.com/buttons/sounds/button-10.mp3');
        const largeMergeSound = new Audio('https://www.soundjay.com/buttons/sounds/button-11.mp3');
        ...
        function moveUp() {
            let moved = false;
            for (let j = 0; j < 4; j++) {
                let col = [board[0][j], board[1][j], board[2][j], board[3][j]].filter(val => val !== 0);
